      ...
      <Layout>
        <div className="px-10 py-10 w-full mx-auto text-gray-500">
          <p className="text-justify indent-8">
            ...
            is an assemblage of portraits of women on rectangle, square and
            round frames. The portraits include traditional paintings and
            archival photographs collaged by way of overlaying brightly coloured
            translucent paints. This exhibition blurs the boundaries of reality
            and fiction by reimagining roles played by women during colonial
            times as well as in the post-colonial epoch. The exhibition takes a
            radical approach against the grain of objectifying women&apos;s
            bodies by juxtaposing realistic renderings their facial expressions
            against smooth backdrops of vibrant hues. The realistic paintings in
            this exhibition challenge stereotypical perceptions of women&apos;s
            roles across the globe by using nuances such as clothing them in
            regal attires and reimagining them in positions of power.
            <br />
            <br />
