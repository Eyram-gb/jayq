    ...
    <Layout>
      <div className="px-10 py-10 w-full mx-auto">
        <div className="w-full mx-auto text-gray-500 pb-10 text-justify">
          ...
          <p>
            In the history of art, artists have created works of excellence that
            have been strongly influenced by the presence of other people in
            their lives. These sources of inspiration have mostly been women -
            i.e. In the case of male artists. There may have been other sources
            of positive influence to the creative works of artists in the past.
            <br />
            ...
            as indigenous belief are left unanswered. There is also the issue of
            whether the idea of muses is totally a Western concept. Also to be
            given strong consideration will be the fact that many women are now
            very active in the field of art. It raises questions like, &apos;Do
            women artists have or believe in the idea of a muse?, Are their
            muses male or female?, etc.
          </p>
          <div className="mt-6">
            <p>
            ...
            <ul className="list-disc mt-2">
              ...
              <li>
                How are female artists going to present their work under such a
                theme?
              </li>
              <li>
          ...
          <p className="mt-8">
            ...
            works of a variety of Ghanaian artists. With contemporary art taking
            different forms and directions, the exhibition intends not to limit
            the whole idea of artists&apos; muses to a singular most specific
            definition of a muse but to show perhaps a collective body of
            interactions with people or experiences that has influenced their
            creativity in a large way.
            <br />
